...
/* Time */
extern volatile uint8_t RealTime_Hour;
extern volatile uint8_t RealTime_Minute;
extern volatile uint8_t RealTime_Second;
...
extern void Set_RealTime(uint8_t hour, uint8_t minute, uint8_t second);
extern void Count_RealTime(void);
